...
exports.defineAutoTests = function() {
  ...
  /*
   * Deprecated builder tests. Keep these for backward compatibility for couple of releases.
   */
  describe('idmAuthFlowPlugin', function () {
    describe('idmAuthFlowPlugin.newHttpBasicAuthentication', function () {
      ...
      it('should validate applicationName.',function() {
        expect(function() { idmAuthFlowPlugin.newHttpBasicAuthPropertiesBuilder().build(); })
        .toThrow(new Error('Mandatory parameter loginUrl not set.'));
      });
      it('should not allow undefined for loginURL.',function() {
        expect(function() { idmAuthFlowPlugin.newHttpBasicAuthPropertiesBuilder('jasmineJsTests').build(); })
        .toThrow(new Error('Mandatory parameter loginUrl not set.'));
      });
      ...
      it('should not allow undefined for logoutURL.',function() {
        expect(function() { idmAuthFlowPlugin.newHttpBasicAuthPropertiesBuilder('jasmineJsTests', 'http://login').build(); })
        .toThrow(new Error('Mandatory parameter logoutUrl not set.'));
      });
      ...
      it('should not allow string for connectivityMode', function() {
        ...
        .toThrow(new Error('ConnectivityMode should be one from HttpBasicAuthPropertiesBuilder.ConnectivityMode.'));
      });
    ...
    describe('idmAuthFlowPlugin.newFederatedAuthentication', function () {
      ...
      it('should validate applicationName.',function() {
        expect(function() { idmAuthFlowPlugin.newFedAuthPropertiesBuilder().build(); })
        .toThrow(new Error('Mandatory parameter loginUrl not set.'));
      });
      it('should not allow undefined for loginURL.',function() {
        expect(function() { idmAuthFlowPlugin.newFedAuthPropertiesBuilder('jasmineJsTests').build(); })
        .toThrow(new Error('Mandatory parameter loginUrl not set.'));
      });
      it('should not allow number for loginURL.',function() {
      ...
      it('should not allow undefined for logoutURL.',function() {
        expect(function() { idmAuthFlowPlugin.newFedAuthPropertiesBuilder('jasmineJsTests', 'http://login').build(); })
        .toThrow(new Error('Mandatory parameter logoutUrl not set.'));
      });
      it('should not allow number for logoutURL.',function() {
      ...
      it('should not allow undefined for loginSuccessURL.',function() {
        expect(function() { idmAuthFlowPlugin.newFedAuthPropertiesBuilder('jasmineJsTests', 'http://login', 'http://logout').build(); })
        .toThrow(new Error('Mandatory parameter loginSuccessUrl not set.'));
      });
      ...
      it('should not allow undefined for loginFailureURL.',function() {
        expect(function() { idmAuthFlowPlugin.newFedAuthPropertiesBuilder('jasmineJsTests', 'http://login', 'http://logout', 'http://loginSucc').build(); })
        .toThrow(new Error('Mandatory parameter loginFailureUrl not set.'));
      });
    ...
    describe('idmAuthFlowPlugin.newOAuthAuthentication', function () {
      ...
      it('should validate applicationName is passed.',function() {
        expect(function() { idmAuthFlowPlugin.newOAuthPropertiesBuilder().build(); })
        .toThrow(new Error('Mandatory parameter oAuthAuthorizationGrantType not set.'));
      });
      it('should not allow undefined for OAuthAuthorizationGrantType', function() {
        expect(function() { idmAuthFlowPlugin.newOAuthPropertiesBuilder('jasmineJsTests').build(); })
        .toThrow(new Error('Mandatory parameter oAuthAuthorizationGrantType not set.'));
      });
      ...
      it('should not allow random string for OAuthAuthorizationGrantType', function() {
        ...
        .toThrow(new Error('OAuthAuthorizationGrantType should be one from OAuthPropertiesBuilder.OAuthAuthorizationGrantType.'));
      });
      it('should not allow undefined for OAuthTokenEndpoint is passed.',function() {
        expect(function() { idmAuthFlowPlugin.newOAuthPropertiesBuilder('jasmineJsTests', idmAuthFlowPlugin.OAuthAuthorizationGrantTypes.OAuthImplicit).build(); })
        .toThrow(new Error('Mandatory parameter oAuthTokenEndpoint not set.'));
      });
      ...
      it('should not allow undefined for oAuthClientID', function() {
        expect(function() { idmAuthFlowPlugin.newOAuthPropertiesBuilder('jasmineJsTests', idmAuthFlowPlugin.OAuthAuthorizationGrantTypes.OAuthImplicit, 'http://tokenEndPoint').build(); })
        .toThrow(new Error('Mandatory parameter oAuthClientID not set.'));
      });
      ...
      it('should not allow random string for browserMode', function() {
        ...
        .toThrow(new Error('BrowserMode should be one from OAuthPropertiesBuilder.BrowserMode.'));
      });
    ...
    it('should validate applicationName is passed.',function() {
      expect(function() { idmAuthFlowPlugin.newOpenIDConnectPropertiesBuilder().build(); })
      .toThrow(new Error('Mandatory parameter discoveryEndpoint not set.'));
    });
    it('should not allow undefined for OAuthAuthorizationGrantType', function() {
      expect(function() { idmAuthFlowPlugin.newOpenIDConnectPropertiesBuilder('jasmineJsTests').build(); })
      .toThrow(new Error('Mandatory parameter discoveryEndpoint not set.'));
    });
    it('should not allow number for OAuthAuthorizationGrantType', function() {
    ...
    it('should not allow undefined for OpenIDConnectDiscoveryURL is passed.',function() {
      expect(function() { idmAuthFlowPlugin.newOpenIDConnectPropertiesBuilder('jasmineJsTests', idmAuthFlowPlugin.OAuthAuthorizationGrantTypes.OAuthImplicit).build(); })
      .toThrow(new Error('Mandatory parameter discoveryEndpoint not set.'));
    });
    ...
    it('should not allow undefined for oAuthClientID', function() {
      expect(function() { idmAuthFlowPlugin.newOpenIDConnectPropertiesBuilder('jasmineJsTests', idmAuthFlowPlugin.OAuthAuthorizationGrantTypes.OAuthImplicit, 'http://discoveryEndPoint').build(); })
      .toThrow(new Error('Mandatory parameter oAuthClientID not set.'));
    });
    it('should not allow number for oAuthClientID', function() {
