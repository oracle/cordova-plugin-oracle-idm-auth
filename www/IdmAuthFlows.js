...
var IdmAuthFlows = function() {
  ...
  var LocalAuthPropertiesBuilder = function(id, pinChallengeCallback){
     ...
     *                  {@link LocalAuthPropertiesBuilder.PinChallengeReason|LocalAuthPropertiesBuilder.PinChallengeReason.Login}
     ...
     * <p>This callback is invoked when there is a requirement to collect PIN from the user.
   ...
   * This is a standard mechanism provided by devices to help user to access the app even when he is unable to provide fingerprint.
   * </p>
